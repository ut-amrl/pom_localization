...
#rosparam set /somewhat_aligned_est_traj_file ${input_dir}tuned_and_sped_up_single_run_slightly_misaligned_kitti_det_local_from_global_est_trajectory_${seq_num}_kitti_runtime_params_cfg_commit_52d288c.csv
