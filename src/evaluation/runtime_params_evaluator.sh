...
rosparam set /${fourth_traj_eval_namespace}/obj_det_curr_traj_file "${base_dir}obj_detections_by_node_${fourth_traj_date}.csv"
rosparam set /${fourth_traj_eval_namespace}/odom_traj_est_file "${base_dir}odom_est_${fourth_traj_date}.csv"
...
rosparam set /${fifth_traj_eval_namespace}/obj_det_curr_traj_file "${base_dir}obj_detections_by_node_${fifth_traj_date}.csv"
rosparam set /${fifth_traj_eval_namespace}/odom_traj_est_file "${base_dir}odom_est_${fifth_traj_date}.csv"
...
rosparam set /${sixth_traj_eval_namespace}/obj_det_curr_traj_file "${base_dir}obj_detections_by_node_${sixth_traj_date}.csv"
rosparam set /${sixth_traj_eval_namespace}/odom_traj_est_file "${base_dir}odom_est_${sixth_traj_date}.csv"
...
rosparam set /${seventh_traj_eval_namespace}/obj_det_curr_traj_file "${base_dir}obj_detections_by_node_${seventh_traj_date}.csv"
rosparam set /${seventh_traj_eval_namespace}/odom_traj_est_file "${base_dir}odom_est_${seventh_traj_date}.csv"
...
rosparam set /${consistency_evaluator_namespace}/trajectory_3/waypoint_to_node_id_file "${base_dir}waypoints_by_node_${fourth_traj_date}.csv"
...
rosparam set /${consistency_evaluator_namespace}/trajectory_4/waypoint_to_node_id_file "${base_dir}waypoints_by_node_${fifth_traj_date}.csv"
...
rosparam set /${consistency_evaluator_namespace}/trajectory_5/waypoint_to_node_id_file "${base_dir}waypoints_by_node_${sixth_traj_date}.csv"
...
rosparam set /${consistency_evaluator_namespace}/trajectory_6/waypoint_to_node_id_file "${base_dir}waypoints_by_node_${seventh_traj_date}.csv"
