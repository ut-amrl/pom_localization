...
namespace synthetic_problem {
    ...
    public:
        ...
        SyntheticProblemRunner2d(const std::shared_ptr<visualization::VisualizationManager> vis_manager) : vis_manager_(vis_manager) {}
        ...
        void runOptimizationVisualization(
            ...
            switch(vis_stage) {
                case offline_optimization::VisualizationTypeEnum::BEFORE_ANY_OPTIMIZATION:
                    ...
                    vis_manager_->displayNoisyCarPosesFromOdomTrajectory(unoptimized_trajectory, noisy_obj_observations);
        ...
        void runSyntheticProblem(const std::vector<pose::Pose2d> &ground_truth_trajectory,
            ...
            offline_optimizer.runOfflineOptimization(
