...
namespace h3d {
    ...
    void readRawLidarOdomLine(const std::string &line_in_file, RawAbsoluteLidarOdomNode3D &lidar_odom_est_data) {
        ...
        lidar_odom_est_data.noise_variance_1_ = 1;
        lidar_odom_est_data.noise_variance_2_ = 1;
        lidar_odom_est_data.noise_variance_3_ = 1;
        lidar_odom_est_data.noise_variance_4_ = 1;
        lidar_odom_est_data.noise_variance_5_ = 1;
        lidar_odom_est_data.noise_variance_6_ = 1;
