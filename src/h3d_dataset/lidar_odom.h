...
namespace h3d {
    ...
    void readRawLidarOdomLine(const std::string &line_in_file, RawAbsoluteLidarOdomNode3D &lidar_odom_est_data) {
        ...
        lidar_odom_est_data.noise_variance_1_ = noise;
        lidar_odom_est_data.noise_variance_2_ = noise;
        lidar_odom_est_data.noise_variance_3_ = noise;
        lidar_odom_est_data.noise_variance_4_ = noise;
        lidar_odom_est_data.noise_variance_5_ = noise;
        lidar_odom_est_data.noise_variance_6_ = noise;
